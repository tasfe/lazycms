...
if (validate_is_post()) {
    ...
    echo           '</tr>';
    echo           '<tr>';
    echo               '<th><label for="Template-tags">'.__('Tags Template').'</label></th>';
    echo               '<td><select name="Template-Tags" id="Template-tags">';
    echo                       options(system_themes_path(),C('TemplateSuffixs'),'<option value="#value#"#selected#>#name#</option>',C('Template-Tags'));
    echo                   '</select>';
    echo               '</td>';
    echo           '</tr>';
    echo           '<tr>';
    echo               '<th><label for="Template-comments">'.__('Comments Template').'</label></th>';
    echo               '<td><select name="Template-Comments" id="Template-comments">';
    echo                       options(system_themes_path(),C('TemplateSuffixs'),'<option value="#value#"#selected#>#name#</option>',C('Template-Comments'));
    echo                   '</select>';
    echo               '</td>';
    echo           '</tr>';
    echo           '<tr>';
