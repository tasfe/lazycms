...
/* @Packager.RemoveLine
// 加载JS库
LoadScripts($("script[src*=js/jquery.js]").attr("src").replace(/(\/js\/jquery\.js\?(.*))/i,'') + '/js/lazycms.js');
@Packager.RemoveLine */
// @Packager.Remove.Start
window.JSPATH = $("script[src*=js/jquery.js]").attr("src").replace(/(common\/js\/jquery\.js\?(.*))/i,'');
LoadScripts(
	window.JSPATH + '_source/js/system.admins.js',
	window.JSPATH + '_source/js/content.article.js',
	window.JSPATH + '_source/js/content.model.js',
	window.JSPATH + '_source/js/content.onepage.js',
	window.JSPATH + '_source/js/content.sort.js',
	window.JSPATH + '_source/js/lazycms.library.js'
);
// @Packager.Remove.End
