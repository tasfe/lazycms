...
(1, 'super', '超级管理员', 'system/system,system/users,system/webftp,system/module,system/settings,content/label,content/create,content/onepage,content/article,content/sort,content/model', 1),
(2, 'admin', '普通管理员', 'system/system,system/users,system/webftp,system/module,system/settings,content/label,content/create,content/onepage,content/article,content/sort,content/model', 1),
(3, 'user', '注册用户', '', 1);
