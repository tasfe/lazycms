...
(1, 'super', '超级管理员', 'system/manage,system/users,system/webftp,system/module,system/settings', 1),
(2, 'admin', '普通管理员', 'system/manage,system/users,system/webftp,system/module,system/settings', 1),
(3, 'user', '注册用户', '', 1);
