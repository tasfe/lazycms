<?php System::header();?>
<?php echo menu($module->L('config/@title').'|'.url('System','Config').';'.$module->L('module/@title').'|'.url('System','Module').';'.$module->L('diymenu/@title').'|#|true;'.$module->L('account/@title').'|'.url('System','MyAccount'));?>
<div class="content">
