...
<?php echo menu($module->L('title').'|'.url('Archives').';'.$menu.';'.$module->L('common/addpage').'|'.url('Archives','Edit'));?>
<div class="content">
    <form action="<?php echo url('Archives','EditSort');?>" method="post" class="lz_form">
