...
<?php echo menu($module->L('title').'|'.url(C('CURRENT_MODULE')).';'.$module->L('models/@title').'|'.url(C('CURRENT_MODULE'),'Models').';'.$module->L('models/add').'|'.url(C('CURRENT_MODULE'),'ModelEdit').';'.$module->L('models/leadin').'|#|true');?>
<div class="content">
