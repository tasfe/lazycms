...
<?php echo menu($module->L('title').'|'.url(C('CURRENT_MODULE')).';'.$module->L('models/@title').'|'.url(C('CURRENT_MODULE'),'Models').';'.$module->L('models/add').'|'.url(C('CURRENT_MODULE'),'ModelEdit').';'.$module->L('models/field/@title').'|'.url(C('CURRENT_MODULE'),'ModelFields','modelid='.$modelid).';'.$menu.';'.L('config/@title').'|'.url(C('CURRENT_MODULE'),'Config'));?>
<div class="content">
