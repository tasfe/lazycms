...
<div class="content">
    <form action="<?php echo url('Onepage','Edit');?>" method="post" class="lz_form">
        ...
        <p><label><?php echo $module->L('label/template1');?></label><input class="in3" type="text" id="onetemplate1" name="onetemplate1" maxlength="50" readonly="true" value="<?php echo $onetemplate1;?>" />&nbsp;<button type="button" onclick="$('#onetemplate1').browseFiles('<?php echo url('System','browseFiles');?>');"><?php echo L('common/browse');?></button></p>
        <p><label><?php echo $module->L('label/template2');?></label><input class="in3" type="text" id="onetemplate2" name="onetemplate2" maxlength="50" readonly="true" value="<?php echo $onetemplate2;?>" />&nbsp;<button type="button" onclick="$('#onetemplate2').browseFiles('<?php echo url('System','browseFiles');?>');"><?php echo L('common/browse');?></button></p>
