...
var arrBlocktag=[{n:'p',t:_('Paragraph')},{n:'h1',t:_('Heading 1')},{n:'h2',t:_('Heading 2')},{n:'h3',t:_('Heading 3')},{n:'h4',t:_('Heading 4')},{n:'h5',t:_('Heading 5')},{n:'h6',t:_('Heading 6')},{n:'pre',t:_('Preformatted')},{n:'address',t:_('Address')}];
...
var arrFontsize=[{n:'xx-small',wkn:'x-small',s:'8pt',t:_('xx-small')},{n:'x-small',wkn:'small',s:'10pt',t:_('x-small')},{n:'small',wkn:'medium',s:'12pt',t:_('small')},{n:'medium',wkn:'large',s:'14pt',t:_('medium')},{n:'large',wkn:'x-large',s:'18pt',t:_('large')},{n:'x-large',wkn:'xx-large',s:'24pt',t:_('x-large')},{n:'xx-large',wkn:'-webkit-xxx-large',s:'36pt',t:_('xx-large')}];
var menuAlign=[{s:_('Align left'),v:'justifyleft'},{s:_('Align center'),v:'justifycenter'},{s:_('Align right'),v:'justifyright'},{s:_('Align full'),v:'justifyfull'}],menuList=[{s:_('Ordered list'),v:'insertOrderedList'},{s:_('Unordered list'),v:'insertUnorderedList'}];
var htmlPastetext='<div>' + _('Use Ctrl+V on your keyboard to paste the text.') + '</div><div><textarea id="xhePastetextValue" wrap="soft" spellcheck="false" style="width:300px;height:100px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="' + _('Ok') + '" /></div>';
var htmlLink='<div>' + _('Link URL:') + ' <input type="text" id="xheLinkUrl" value="http://" class="xheText" /></div><div>' + _('Target:&nbsp;&nbsp;') + ' <select id="xheLinkTarget"><option selected="selected" value="">' + _('Default') +'</option><option value="_blank">' + _('New window') + '</option><option value="_self">' + _('Same window') + '</option><option value="_parent">' + _('Parent window') + '</option></select></div><div style="display:none">' + _('Link Text:') + ' <input type="text" id="xheLinkText" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="' + _('Ok') + '" /></div>';
var htmlImg='<div>' + _('Img URL:&nbsp;') + ' <input type="text" id="xheImgUrl" value="http://" class="xheText" /></div><div>' + _('Alt text:') + ' <input type="text" id="xheImgAlt" /></div><div>' + _('Alignment:') + ' <select id="xheImgAlign"><option selected="selected" value="">' + _('Default') +'</option><option value="left">' + _('Left') + '</option><option value="right">' + _('Right') + '</option><option value="top">' + _('Top') + '</option><option value="middle">' + _('Middle') + '</option><option value="baseline">' + _('Baseline') + '</option><option value="bottom">' + _('Bottom') + '</option></select></div><div>' + _('Dimension:') + ' <input type="text" id="xheImgWidth" style="width:40px;" /> x <input type="text" id="xheImgHeight" style="width:40px;" /></div><div>' + _('Border:&nbsp;&nbsp;&nbsp;') + ' <input type="text" id="xheImgBorder" style="width:40px;" /></div><div>' + _('Hspace:&nbsp;&nbsp;&nbsp;') + ' <input type="text" id="xheImgHspace" style="width:40px;" /> ' + _('Vspace:') + ' <input type="text" id="xheImgVspace" style="width:40px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="' + _('Ok') + '" /></div>';
var htmlFlash='<div>' + _('Flash URL:') + ' <input type="text" id="xheFlashUrl" value="http://" class="xheText" /></div><div>' + _('Dimension:') + ' <input type="text" id="xheFlashWidth" style="width:40px;" value="480" /> x <input type="text" id="xheFlashHeight" style="width:40px;" value="400" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="' + _('Ok') + '" /></div>';
var htmlMedia='<div>' + _('Media URL:') + ' <input type="text" id="xheMediaUrl" value="http://" class="xheText" /></div><div>' + _('Dimension:') + ' <input type="text" id="xheMediaWidth" style="width:40px;" value="480" /> x <input type="text" id="xheMediaHeight" style="width:40px;" value="400" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="' + _('Ok') + '" /></div>';
var htmlTable='<div>' + _('Rows&Cols:&nbsp;&nbsp;') + ' <input type="text" id="xheTableRows" style="width:40px;" value="3" /> x <input type="text" id="xheTableColumns" style="width:40px;" value="2" /></div><div>' + _('Headers:&nbsp;&nbsp;&nbsp;&nbsp;') + ' <select id="xheTableHeaders"><option selected="selected" value="">' + _('None') + '</option><option value="row">' + _('First row') + '</option><option value="col">' + _('First column') + '</option><option value="both">' + _('Both') + '</option></select></div><div>' + _('Dimension:') + ' <input type="text" id="xheTableWidth" style="width:40px;" value="200" /> x <input type="text" id="xheTableHeight" style="width:40px;" value="" /></div><div>' + _('Border:&nbsp;&nbsp;&nbsp;') + ' <input type="text" id="xheTableBorder" style="width:40px;" value="1" /></div><div>' + _('CellSpacing:') + ' <input type="text" id="xheTableCellSpacing" style="width:40px;" value="1" /> ' + _('CellPadding:') + ' <input type="text" id="xheTableCellPadding" style="width:40px;" value="1" /></div><div>' + _('Alignment:') + ' <select id="xheTableAlign"><option selected="selected" value="">' + _('Default') +'</option><option value="left">' + _('Left') + '</option><option value="center">' + _('Center') + '</option><option value="right">' + _('Right') + '</option></select></div><div>' + _('Caption:&nbsp;&nbsp;&nbsp;&nbsp;') + ' <input type="text" id="xheTableCaption" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="' + _('Ok') + '" /></div>';
var htmlAbout='<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.1.2 (build 101201)</p><p>' + _('xhEditor is a platform independent WYSWYG XHTML editor based by jQuery,released as Open Source under <a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>.') + '</p><p>Copyright © <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>';
var itemEmots={'default':{name:_('Default'),width:24,height:24,line:7,list:{'smile':_('Smile'),'tongue':_('Tongue'),'titter':_('Titter'),'laugh':_('Laugh'),'sad':_('Sad'),'wronged':_('Wronged'),'fastcry':_('Fast cry'),'cry':_('Cry'),'wail':_('Wail'),'mad':_('Mad'),'knock':_('Knock'),'curse':_('Curse'),'crazy':_('Crazy'),'angry':_('Angry'),'ohmy':_('Oh my'),'awkward':_('Awkward'),'panic':_('Panic'),'shy':_('Shy'),'cute':_('Cute'),'envy':_('Envy'),'proud':_('Proud'),'struggle':_('Struggle'),'quiet':_('Quiet'),'shutup':_('Shut up'),'doubt':_('Doubt'),'despise':_('Despise'),'sleep':_('Sleep'),'bye':_('Bye')}}};
var arrTools={Cut:{t:_('Cut (Ctrl+X)')},Copy:{t:_('Copy (Ctrl+C)')},Paste:{t:_('Paste (Ctrl+V)')},Pastetext:{t:_('Paste as plain text'),h:isIE?0:1},Blocktag:{t:_('Block tag'),h:1},Fontface:{t:_('Font family'),h:1},FontSize:{t:_('Font size'),h:1},Bold:{t:_('Bold (Ctrl+B)'),s:'Ctrl+B'},Italic:{t:_('Italic (Ctrl+I)'),s:'Ctrl+I'},Underline:{t:_('Underline (Ctrl+U)'),s:'Ctrl+U'},Strikethrough:{t:_('Strikethrough (Ctrl+S)'),s:'Ctrl+S'},FontColor:{t:_('Select text color'),h:1},BackColor:{t:_('Select background color'),h:1},SelectAll:{t:_('SelectAll (Ctrl+A)')},Removeformat:{t:_('Remove formatting')},Align:{t:_('Align'),h:1},List:{t:_('List'),h:1},Outdent:{t:_('Outdent (Shift+Tab)'),s:'Shift+Tab'},Indent:{t:_('Indent (Tab)'),s:'Tab'},Link:{t:_('Insert/edit link (Ctrl+K)'),s:'Ctrl+K',h:1},Unlink:{t:_('Unlink')},Img:{t:_('Insert/edit image'),h:1},Flash:{t:_('Insert/edit flash'),h:1},Media:{t:_('Insert/edit media'),h:1},Emot:{t:_('Emotions'),s:'ctrl+e',h:1},Table:{t:_('Insert a new table'),h:1},Source:{t:_('Edit source code')},Preview:{t:_('Preview')},Print:{t:_('Print (Ctrl+P)'),s:'Ctrl+P'},Fullscreen:{t:_('Toggle fullscreen (Esc)'),s:'Esc'},About:{t:_('About xhEditor')}};
var toolsThemes={
...
$.xheditor=function(textarea,options)
{
	...
	var headHTML='',bodyClass='',skinPath=editorRoot+'skins/'+settings.skin+'/',arrEmots=itemEmots,urlType=settings.urlType,urlBase=settings.urlBase,emotPath=settings.emotPath,emotPath=emotPath?emotPath:editorRoot+'emots/',selEmotGroup='';
	...
	this.init=function()
	{
		...
		{
			alert(_('Current textarea is hidden, please make it show before initialization xhEditor, or directly initialize the height.'));
			return false;
		}
	...
	this.showPreview=function()
	{
		...
		var sHTML='<html><head>'+headHTML+'<title>' + _('Preview') + '</title>'+(urlBase?'<base href="'+urlBase+'"/>':'')+'</head><body>' + sContent + '</body></html>';
	...
	this.startUpload=function(fromFiles,toUrl,limitExt,onUploadComplete)
	{
		...
		var upload,fileList,filename,jUploadTip=$('<div style="padding:22px 0;text-align:center;line-height:30px;">' + _('File uploading,please wait...') + '<br /></div>'),sLoading='<img src="'+skinPath+'img/loading.gif">';
		...
		else
		{
			...
			if(len>upMultiple){alert(_('Please do not upload more then \{$upMultiple\} files.').replace('\{$upMultiple\}', upMultiple));return;}
		...
		_this.showModal(_('File uploading(Esc cancel)'),jUploadTip,320,150,function(){bShowPanel=panelState;upload.remove();});
		upload.start();
		function onUploadCallback(sText,bFinish)
		{
			var data=Object,bOK=false;
			try{data=eval('('+sText+')');}catch(ex){};
			if(data.err===undefined||data.msg===undefined)alert(toUrl+_(' upload interface error!') + '\r\n\r\n' +  _('return error:') + ' \r\n\r\n'+sText);
			else
			{
	...
	this.showModal=function(title,content,w,h,onRemove)
	{
		...
		jModal=$('<div class="xheModal" style="width:'+(w-1)+'px;height:'+h+'px;margin-left:-'+Math.ceil(w/2)+'px;'+(isIE&&browerVer<=7.0?'':'margin-top:-'+Math.ceil(h/2)+'px')+'">'+(settings.modalTitle?'<div class="xheModalTitle"><span class="xheModalClose" title="' + _('Close (Esc)') + '"></span>'+title+'</div>':'')+'<div class="xheModalContent"></div></div>').appendTo('body');
	...
	this.showDialog=function(content)
	{
		...
		if(jSave.length===1)
		{
			...
			jSave.after(' <input type="button" id="xheCancel" value="' + _('Cancel') + '" />');
		...
		else//内置工具
		{
			...
			switch(cmd)
			{
				case 'cut':
					...
					catch(ex){alert(_('Currently not supported by your browser, use keyboard shortcuts(Ctrl+X) instead.'));};
					break;
				case 'copy':
					try{_doc.execCommand(cmd);if(!_doc.queryCommandSupported(cmd))throw 'Error';}
					catch(ex){alert(_('Currently not supported by your browser, use keyboard shortcuts(Ctrl+C) instead.'));}
					break;
				case 'paste':
					try{_doc.execCommand(cmd);if(!_doc.queryCommandSupported(cmd))throw 'Error';}
					catch(ex){alert(_('Currently not supported by your browser, use keyboard shortcuts(Ctrl+V) instead.'));}
					break;
				case 'pastetext':
