...
var menuAlign=[{s:_('Align left'),v:'justifyleft'},{s:_('Align right'),v:'justifycenter'},{s:_('Align center'),v:'justifyright'},{s:_('Align full'),v:'justifyfull'}],menuList=[{s:_('Ordered list'),v:'insertOrderedList'},{s:_('Unordered list'),v:'insertUnorderedList'}];
