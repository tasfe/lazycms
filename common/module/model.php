...
class LCModel {
     ...
     * @return array|null
     */
    function getModelById($modelid,$field='*') {
        $modelid = intval($modelid);
        $model = LCModel::getModel($modelid,0);
        if ($field!='*') {
     ...
     * @return array|null
     */
    function getModel($param,$type=0,$language=null) {
