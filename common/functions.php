...
// but *** *** www.LazyCMS.net *** ***
function but($l1){
    $I1 = '<p class="button"><button type="submit" class="submit" onclick="$(this.form).save();">'.L("common/{$l1}").'</button>';
    $I1.= '<button type="button" class="apply" onclick="$(this.form).apply();">'.L("common/apply").'</button>';
