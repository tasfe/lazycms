    ...
    function scripts(){
        return array(
            ...
            'common'        => array(COM_PATH.'/js/lazycms.js',array('jquery','jquery.extend'),array(
                                    ...
                                    'Save'    => _('Save'),
                                    'Close'   => _('Close'),
                                    'No record!'        => _('No record!'),
                                    'Upgrade Tips'      => _('Upgrade Tips'),
                                    'Current:'          => _('Current:'),
                                    'Recommended:'      => _('Recommended:'),
                                    'Confirm Logout?'   => _('Confirm Logout?'),
                                    'Confirm Delete?'   => _('Confirm Delete?'),
                                    '(Recommended to upgrade to IE 7.0 +)' => _('(Recommended to upgrade to IE 7.0 +)'),
                                )),
            ...
            'model'         => array(ADMIN_PATH.'/js/model.js',array('admin'),array(
                                    'field' => array(
                                        'Add New'   => __('Add New','field'),
                                    ),
                                    'The label field is empty.' => __('The label field is empty.','field'),
                                    'The name field is empty.'  => __('The name field is empty.','field'),
                                    'The name already exists.'  => __('The name already exists.','field'),
                                )),
