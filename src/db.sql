...
INSERT INTO `lazy_model` (`modelid`, `language`, `code`, `name`, `path`, `list`, `page`, `fields`, `state`) VALUES
(1, 'zh-CN', 'article', '文章', '%ID.html', 'default.html', 'default.html', 'a:1:{i:0;s:115:"l=%E6%9D%A5%E6%BA%90&n=from&t=select&w=200px&s=%E6%9C%AA%E7%9F%A5%0A%E7%BD%91%E7%BB%9C%0ALukin&d=%E7%BD%91%E7%BB%9C";}', '1'),
(2, 'zh-CN', 'download', '下载', '%ID.html', 'default.html', 'default.html', 'a:1:{i:0;s:73:"l=%E4%B8%8B%E8%BD%BD%E5%9C%B0%E5%9D%80&n=downurl&t=input&w=500px&c=255&d=";}', '1');
...
CREATE TABLE IF NOT EXISTS `lazy_option` (
...
INSERT INTO `lazy_option` (`module`, `code`, `value`, `type`) VALUES
('System', 'SiteName', 'LazyCMS v2.0 演示站', 'string'),
('System', 'Template', 'themes', 'string'),
('System', 'TemplateSuffixs', 'htm,html,shtml', 'string'),
('System', 'HTMLSaveDir', 'a/', 'string'),
('System', 'HTMLFileSuffix', '.html', 'string');
...
CREATE TABLE IF NOT EXISTS `lazy_pinyin` (
...
INSERT INTO `lazy_pinyin` (`key`, `value`) VALUES
('a', '啊,阿,锕'),
...
CREATE TABLE IF NOT EXISTS `lazy_post` (
...
INSERT INTO `lazy_post` (`postid`, `sortid`, `model`, `author`, `path`, `title`, `content`, `passed`, `datetime`, `template`, `description`) VALUES
(2, 0, 'zh-CN:download', 1, '2.html', '软件名称''s', '软件内容描述', 0, 1277549567, '', 'Meta简述'),
(3, 3, 'zh-CN:article', 2, '3.html', 'test', 'tsta', 0, 1282926235, '', 'aaaaaaaa'),
(4, 2, 'zh-CN:article', 2, '4.html', '中国的新闻，都是媒体工具', '中国的新闻，都是媒体工具中国的新闻，都是媒体工具中国的新闻，都是媒体工具', 0, 1282928136, '', '中国的新闻，都是媒体工具');
...
CREATE TABLE IF NOT EXISTS `lazy_post_meta` (
...
--
-- 转存表中的数据 `lazy_post_meta`
--

INSERT INTO `lazy_post_meta` (`metaid`, `postid`, `key`, `value`, `type`) VALUES
(5, 2, 'downurl', '下载地址ddd', 'string'),
(6, 3, 'from', '网络', 'string'),
(7, 4, 'from', '网络', 'string');
...
CREATE TABLE IF NOT EXISTS `lazy_term` (
...
INSERT INTO `lazy_term` (`termid`, `name`) VALUES
(1, '新闻'),
(2, '地方新闻'),
(3, '社会新闻'),
(4, '下载'),
...
--
-- 表的结构 `lazy_term_relation`
--

DROP TABLE IF EXISTS `lazy_term_relation`;
CREATE TABLE IF NOT EXISTS `lazy_term_relation` (
...
--
-- 转存表中的数据 `lazy_term_relation`
--

INSERT INTO `lazy_term_relation` (`objectid`, `taxonomyid`, `order`) VALUES
(2, 5, 0),
(2, 22, 3),
(2, 21, 1),
(2, 13, 2),
...
--
-- 表的结构 `lazy_term_taxonomy`
--

DROP TABLE IF EXISTS `lazy_term_taxonomy`;
CREATE TABLE IF NOT EXISTS `lazy_term_taxonomy` (
...
--
-- 转存表中的数据 `lazy_term_taxonomy`
--

INSERT INTO `lazy_term_taxonomy` (`taxonomyid`, `termid`, `type`, `parent`, `count`) VALUES
(1, 1, 'category', 0, 0),
(2, 2, 'category', 1, 0),
(3, 3, 'category', 2, 0),
(4, 4, 'category', 0, 0),
...
--
-- 表的结构 `lazy_term_taxonomy_meta`
--

DROP TABLE IF EXISTS `lazy_term_taxonomy_meta`;
CREATE TABLE IF NOT EXISTS `lazy_term_taxonomy_meta` (
  `metaid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `taxonomyid` bigint(20) unsigned NOT NULL,
...
--
-- 转存表中的数据 `lazy_term_taxonomy_meta`
--

INSERT INTO `lazy_term_taxonomy_meta` (`metaid`, `taxonomyid`, `key`, `value`, `type`) VALUES
(1, 1, 'path', '%PY', 'string'),
(2, 1, 'list', '', 'string'),
(3, 2, 'path', '%PY', 'string'),
(4, 2, 'list', '', 'string'),
...
(7, 4, 'path', '%PY', 'string'),
(8, 4, 'list', '', 'string'),
(9, 5, 'path', 'XiaZai/%PY', 'string'),
(10, 5, 'list', '', 'string'),
(11, 6, 'path', 'XiaZai/WangLuoGongJu/%PY', 'string'),
(12, 6, 'list', '', 'string'),
(13, 7, 'path', 'XiaZai/%PY', 'string'),
(14, 7, 'list', '', 'string'),
(15, 8, 'path', 'XiaZai/%PY', 'string'),
(16, 8, 'list', '', 'string'),
(17, 9, 'path', 'XiaZai/%PY', 'string'),
(18, 9, 'list', '', 'string'),
(19, 10, 'path', 'XiaZai/%PY', 'string'),
(20, 10, 'list', '', 'string'),
(21, 11, 'path', 'XiaZai/WangLuoGongJu/%PY', 'string'),
(22, 11, 'list', '', 'string'),
(23, 12, 'path', 'XiaZai/WangLuoGongJu/%PY', 'string'),
(24, 12, 'list', '', 'string'),
(25, 13, 'path', 'XiaZai/WangLuoGongJu/%PY', 'string'),
(26, 13, 'list', '', 'string'),
(27, 14, 'path', 'XiaZai/AnQuanXiangGuan/%PY', 'string'),
(28, 14, 'list', '', 'string'),
(29, 15, 'path', 'XiaZai/AnQuanXiangGuan/', 'string'),
(30, 15, 'list', '', 'string'),
(31, 16, 'path', 'XiaZai/AnQuanXiangGuan/%PY', 'string'),
(32, 16, 'list', '', 'string');
...
CREATE TABLE IF NOT EXISTS `lazy_user` (
...
INSERT INTO `lazy_user` (`userid`, `name`, `pass`, `mail`, `status`, `registered`, `authcode`) VALUES
(1, 'admin', '6a533d1f0cb2ee7f2116e02c9a932f56', 'my@lukin.cn', 0, '0000-00-00 00:00:00', '03133D1F-72BB-FCC6-4C4F-A41E432E3B0E'),
(2, 'Lukin', 'dd7c2e871ccf814c328134b32c565392', 'mmmm@sss.com', 0, '2010-05-06 21:13:21', '2F3B5358-69C3-1559-8B48-539C164AFFD9');
...
CREATE TABLE IF NOT EXISTS `lazy_user_meta` (
  `metaid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `lazy_user_meta`
--

INSERT INTO `lazy_user_meta` (`metaid`, `userid`, `key`, `value`, `type`) VALUES
(1, 1, 'Administrator', 'Yes', 'string'),
(2, 1, 'roles', 'a:21:{i:0;s:10:"categories";i:1;s:8:"post-new";i:2;s:9:"post-list";i:3;s:9:"post-edit";i:4;s:11:"post-delete";i:5;s:10:"topic-list";i:6;s:9:"topic-new";i:7;s:10:"topic-edit";i:8;s:12:"topic-delete";i:9;s:10:"model-list";i:10;s:9:"model-new";i:11;s:10:"model-edit";i:12;s:12:"model-delete";i:13;s:12:"model-import";i:14;s:12:"model-export";i:15;s:12:"model-fields";i:16;s:9:"user-list";i:17;s:8:"user-new";i:18;s:9:"user-edit";i:19;s:11:"user-delete";i:20;s:14:"option-general";}', 'array'),
(3, 1, 'username', 'admin', 'string'),
(4, 1, 'url', 'http://lukin.net', 'string'),
(5, 1, 'nickname', 'Lukin', 'string'),
(6, 1, 'description', '', 'string'),
(7, 2, 'url', 's', 'string'),
(8, 2, 'roles', 'a:16:{i:0;s:10:"categories";i:1;s:8:"post-new";i:2;s:9:"post-list";i:3;s:9:"post-edit";i:4;s:8:"post-del";i:5;s:10:"model-list";i:6;s:9:"model-new";i:7;s:10:"model-edit";i:8;s:12:"model-delete";i:9;s:12:"model-import";i:10;s:12:"model-export";i:11;s:12:"model-fields";i:12;s:9:"user-list";i:13;s:8:"user-new";i:14;s:9:"user-edit";i:15;s:11:"user-delete";}', 'array'),
(9, 2, 'nickname', 'Lukin', 'string'),
(10, 2, 'Administrator', 'Yes', 'string'),
